...
This code has been a work in progress for many many years and is being given to users as freeware for tumblr lovers. It has no tracking scripts at all, no spyware, nothing but the scripts required to run the applets, coloris engine, and widgets.
